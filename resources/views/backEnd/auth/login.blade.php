                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">PatiJoy | Hoşgeldiniz</h1>
                                    </div>
                                    @if ($errors->any())
                                    ...
                                    <form class="user" method="post" action="{{route('admin.login.post')}}">
                                        ...
                                        <a href="#" class="btn btn-google btn-user btn-block">
                                            <i class="fab fa-google fa-fw"></i> Google ile Giriş Yap</a>
                                        <a href="#" class="btn btn-facebook btn-user btn-block">
                                            <i class="fab fa-facebook-f fa-fw"></i> Facebook ile Giriş Yap</a>
                                    </form>
                                    <hr>
                                    <div class="text-center">
                                    ...
                                    <div class="text-center">
                                        <a class="small" href="{{route('admin.register')}}">Hesap Oluştur!</a><br/>
