    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('admin.dashboard')}}">
                ...
                <div class="sidebar-brand-text mx-1">PatiJoy</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePage" class="collapse @if(Request::segment(2)=="sayfalar") show @endif" aria-labelledby="headingPage" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item @if(Request::segment(2)=="sayfalar" and !Request::segment(3)) active @endif" href="@if(Auth::user()->auth==1) {{route('admin.page.index')}} @else {{route('admin.dashboard')}} @endif">Mevcut Sayfalar</a>
                        <a class="collapse-item @if(Request::segment(2)=="sayfalar" and Request::segment(3)=='olustur') active @endif"  href="@if(Auth::user()->auth==1) {{route('admin.page.create')}} @else {{route('admin.dashboard')}} @endif">Sayfa Oluştur</a>
                    </div>
                </div>
            </li>
