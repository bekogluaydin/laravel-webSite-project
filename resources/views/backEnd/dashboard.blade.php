...
@section('title', 'PatiJoy Bilgi Paneli')
@section('content')
<div class="row">
                ...
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                            Toplam Makale Görüntülenme</div>
    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <div class="card border-left-info shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Oluşturulan Kategoriler
                        </div>
                        <div class="row no-gutters align-items-center">
                            <div class="col-auto">
