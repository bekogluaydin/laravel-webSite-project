        ...
        <form method="POST" action="{{ route('comments.store') }}">
            ...
            @if(isset($guest_commenting) and $guest_commenting == true)
                <div class="form-group">
                    <label for="message">@lang('İsim*')</label>
                ...
                <div class="form-group">
                    <label for="message">@lang('E-posta*')</label>
            ...
            <button type="submit" class="btn btn-sm btn-outline-success text-uppercase">@lang('yorum yap')</button>
        </form>
    </div>
</div>
<br />